...
<b>Bot Maintained By: @kc_bots \n
<b>Do /help for more...</b> \n
"""

    RENAME_403_ERR = "What Are You Doing? Bruuh!!"
    BANNED_USER_TEXT = "Sorry!! But Kc Owner As Banned You From Using This Service. That Means You Can't Run Meh Now! \n \n Contact : @kc_bots For more Details.. " 
    ABS_TEXT = "What Are You Trying To Do,Mate?"
    UPGRADE_TEXT = "CONTACT Still waiting zone "
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me JOin > @kc_bots  ❤️**"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds"
    NOT_AUTH_USER_TEXT = "CONTACT Nobody "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact nobody "
